...
>(
  (
    ...
    const onSelect = React.useCallback((api: UseEmblaCarouselType[1]) => {
      setCanScrollPrev(api!.canScrollPrev()); // Added non-null assertion
      setCanScrollNext(api!.canScrollNext()); // Added non-null assertion
    }, []);
