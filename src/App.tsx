import { Toaster as Sonner } from "@/components/ui/sonner";
    ...
    import TagManagementPage from "./pages/admin/TagManagementPage"; // Import the new page
                  ...
                  <Routes>
                    ...
                    <Route element={<ProtectedRoute />}>
                      ...
                      <Route element={<AdminProtectedRoute />}>
                        ...
                        <Route path="/admin/tags" element={<TagManagementPage />} /> {/* New Tag Management Route */}
                      </Route>
