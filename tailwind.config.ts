          ...
          colors: {
            ...
            tag: {
              default: {
                ...
                foreground: "hsl(var(--tag-default-foreground))",
              },
              blue: {
              ...
              orange: {
                DEFAULT: "hsl(var(--tag-orange))",
                foreground: "hsl(var(--tag-orange-foreground))",
              },
              yellow: {
                DEFAULT: "hsl(var(--tag-yellow))",
                foreground: "hsl(var(--tag-yellow-foreground))",
              },
              teal: {
                DEFAULT: "hsl(var(--tag-teal))",
                foreground: "hsl(var(--tag-teal-foreground))",
              },
            },
          },
          borderRadius: {
